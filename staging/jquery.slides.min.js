...
(function () {
    (function (e, t, n) {
        var r, i, s;
        s = "slidesjs";
        i = {width: 1240, height: 980, start: 1, navigation: {active: !0, effect: "slide"}, pagination: {active: !0, effect: "slide"}, play: {active: !1, effect: "slide", interval: 5e3, auto: !1, swap: !0, pauseOnHover: !1, restartDelay: 2500}, effect: {slide: {speed: 500}, fade: {speed: 300, crossfade: !0}}, callback: {loaded: function () {
        }, start: function () {
        }, complete: function () {
        }}};
        r = function () {
        ...
        r.prototype.init = function () {
            ...
            e(".slidesjs-control", n).children().addClass("slidesjs-slide").css({position: "absolute", top: 0, left: 0, width: "110%", height:"100%", zIndex: 0, display: "none", webkitBackfaceVisibility: "hidden"});
